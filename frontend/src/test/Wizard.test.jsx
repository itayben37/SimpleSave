...
describe('Wizard — submit button', () => {
  ...
  it('navigates to /personal (not /register) on successful submit', async () => {
    ...
    const submitBtn = await screen.findByText('סיום והרשמה')
    fireEvent.click(submitBtn)

    await waitFor(() => expect(mockNavigate).toHaveBeenCalledWith('/personal'))
